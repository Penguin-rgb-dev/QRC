...
from Models import get_Pauli_X, get_Pauli_Y, get_Pauli_Z, get_XX, get_YY ,get_ZZ, Heisenberg_1DNN_general
...
# --- 2. MODEL SETUP ---
N, J_val, h_val, tau = 10, 1/4, 0.2, 10
Hamiltonian, Ji, _ = Heisenberg_1DNN_general(N,(0,J_val),h_val,rng)  # PUT YOU HAMILTONIAN HERE!
