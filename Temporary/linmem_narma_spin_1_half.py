...
from Models import get_Pauli_X, get_Pauli_Y, get_Pauli_Z, get_XX, get_YY ,get_ZZ, J_matrix, Spin_1DNN_general
...
J_3 = np.full(N, 1)
J_4 = np.full(N, 1)
h_i = rng.uniform(low=-h_val, high=h_val, size=N)
Hamiltonian = Spin_1DNN_general(N, J_0, J_1, J_2, J_3, J_4, h_i, rng)  # PUT YOU HAMILTONIAN HERE!
